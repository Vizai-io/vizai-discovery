 ...
 */
export async function extractWebsiteSignals(websiteUrl: string, profileId: string): Promise<WebsiteSignal | null> {
  try {
    ...
    const serviceKeywords = detectKeywords(html, [
    ...
    const locationReferences = detectKeywords(html, [
