...
const envSchema = z.object({
  ...
  STRIPE_TIER0_SNAPSHOT_PRICE_ID: z.string().optional(),
  STRIPE_TIER1_FOUNDATION_SETUP_PRICE_ID: z.string().optional(),
  STRIPE_TIER1_FOUNDATION_MONTHLY_PRICE_ID: z.string().optional(),
  STRIPE_TIER2_REINFORCEMENT_SETUP_PRICE_ID: z.string().optional(),
  STRIPE_TIER2_REINFORCEMENT_MONTHLY_PRICE_ID: z.string().optional(),
  STRIPE_TIER3_GOVERNANCE_SETUP_PRICE_ID: z.string().optional(),
  STRIPE_TIER3_GOVERNANCE_MONTHLY_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_COMPETITOR_COMPARISON_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_EXTENDED_QUERY_PACK_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_QUARTERLY_DEEP_AUDIT_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_CONTENT_OPTIMIZATION_PAGE_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_MULTI_LANGUAGE_TESTING_PRICE_ID: z.string().optional(),
  STRIPE_ADDON_PRIORITY_SUPPORT_MONTHLY_PRICE_ID: z.string().optional(),
